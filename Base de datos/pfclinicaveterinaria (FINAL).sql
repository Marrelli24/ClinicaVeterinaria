...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-10-2023 a las 17:39:11
...
INSERT INTO `cliente` (`idCliente`, `dni`, `nombre`, `apellido`, `telefono`, `direccion`, `nombreAlterno`, `contactoAlternativo`, `estado`) VALUES
(1, 38299859, 'Ezequiel', 'Marrelli', 154100010, 'Av Sarmiento', 'Matias', 155202020, 1),
(2, 31100100, 'Mauro', 'Alvarez', 154100010, 'Av Sarmiento', '', 155202020, 0),
(3, 40123456, 'Juan', 'Martinez', 154999999, 'Av San Martin', '', 154888888, 0),
(4, 41123456, 'Marcelo', 'Martinez', 154999999, 'Av San Martin', '', 154888888, 0),
(5, 28888999, 'Julia', 'Marquez', 154222333, 'Av Belgrano', '', 154100200, 0),
(6, 29888999, 'Julieta', 'Marquez', 154222333, 'Av Belgrano', '', 154100200, 0),
(7, 18100100, 'Ezequiel', 'Lopez', 154151515, 'nose', '', 154987654, 0),
(8, 19100100, 'Pedro', 'Lopez', 154151515, 'nose', '', 154987654, 0),
(9, 26000000, 'Juan', 'Alvarez', 11111111, 'Av Sarmiento', '', 2222222, 0),
(10, 1123234, 'Julia', 'Alvarez', 11111111, 'Av San Martin', '', 2222222, 0),
(15, 1, 'Grupito', 'Java', 11111111, 'ArgentinaPrograma', 'Nadie', 2222222, 0);
...
INSERT INTO `mascota` (`idMascota`, `alias`, `sexo`, `especie`, `raza`, `colorPelo`, `peso`, `pesoPromedio`, `fechaNac`, `idCliente`, `estado`) VALUES
(1, 'Indiana', 'Hembra', 'Canino', 'Caniche', 'Blanco', 7.000, 6.833, '2016-06-15', 1, 1),
(2, 'Catalina', 'Hembra', 'Felino', 'Calle', 'Naranja blanco', 6.000, 6.000, '2017-08-16', 4, 0),
(3, 'Leo', 'Macho', 'Canino', 'Salchicha', 'Marron', 4.000, 4.000, '2018-08-16', 5, 0),
(4, 'Messi', 'macho', 'Canino', 'Labrador', 'Negro', 14.000, 14.833, '2022-06-24', 1, 1),
(5, 'Salchicha', 'Macho', 'Perro', 'Salchicha', 'Negro', 5.100, 5.267, '2022-03-23', 1, 0),
(6, 'Peluca', 'Hembra', 'Canino', 'Caniche', 'Marron', 0.000, 0.000, '2023-10-01', 15, 0);
...
(1, 'Baño', '0', 5000, 'Estetica', 0),
(2, 'Desparacitar', '1', 7000, 'Control', 1),
(3, 'Vacunacion', '1,3,4', 17000, 'Vacunacion', 1);
...
(18, 1, '2023-10-26', 'Vacunancion Anual', 7.000, 3, 1),
(19, 4, '2023-10-26', 'Vacunacion', 14.000, 3, 0);
...
--
ALTER TABLE `factura`
  MODIFY `NroFactura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `visita`
  MODIFY `idVisita` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
